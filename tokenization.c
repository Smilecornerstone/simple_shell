 ...
 * @word1: Number one word to join
 * @word2: Number two word to join
 * @word3: Number three word to join
 * @sep: Separator between the words
 *
 * Return: Line composed by three parts followed by a separator and
 * ended by a new line
 **/
